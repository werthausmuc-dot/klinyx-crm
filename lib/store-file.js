...
//
// IMPORTANT: this backend only makes sense when the disk it writes to
// actually survives restarts and redeploys (a real VPS, a Docker volume,
// a host with a persistent disk). On a host with an ephemeral filesystem
// (e.g. Render's free plan) every write here is lost on the next restart.
// See lib/store-mongo.js + lib/store.js for the alternative backend that
// solves this for free using a MongoDB Atlas account instead of local disk.
