...
module.exports = function registerInvoiceRoutes(router) {
  router.get("/api/invoices", async (req, res) => {
    ...
    sendJson(res, 200, await store.list("invoices"));
  });
  ...
  router.post("/api/invoices", async (req, res) => {
    ...
    sendJson(res, 201, await store.create("invoices", data));
  });
  ...
  router.patch("/api/invoices/:id", async (req, res, params) => {
    ...
    sendJson(res, 200, await store.update("invoices", params.id, patch));
  });
